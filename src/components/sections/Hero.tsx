...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-[15%] w-72 h-72 bg-gradient-to-br from-amber-200/40 to-amber-400/20 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-[10%] w-96 h-96 bg-gradient-to-br from-amber-300/30 to-orange-200/20 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Main Heading */}
          <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[1.1] mb-8 animate-fade-up">
            Empowering{" "}
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-6 md:gap-12 mt-10 pt-8 border-t border-amber-200/50 animate-fade-up">
            {stats.map((stat) => (
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce-subtle">
        <a href="#shop" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
